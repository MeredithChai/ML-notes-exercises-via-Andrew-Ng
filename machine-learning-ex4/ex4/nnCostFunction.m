...
% 12-07 Me:
    ...
    % get grads completely (with regularization)
    ...
    % get J without regularization
    J = 1/m * sum(sum(-Y_cal.*log(h_x) - (1.0-Y_cal).*log(1.0-h_x)));
    % get J completely
